...
excel_path = 'G:\\Unidades compartidas\\Workforce\\r\\41561651 Recovery_Monthly_Brasil.xlsx'

ruta_base = "G:\\Unidades compartidas\\Workforce\\r\\registros"
fecha_hoy = datetime.now().strftime("%Y-%m-%d")

sheets_picture = ['Summary', 'Failed', 'BNPL']
ranges_picture = ['A1:Z60', 'A1:Z43', 'A1:Z43']
temp_folder = 'G:\\Unidades compartidas\\Workforce\\r\\descargas\\Recovery Brazil\\Capturas\\'
...
with sync_playwright() as p:
    ...
    try:
        ...
        with open(ruta_completa, "a", encoding="utf-8") as f:
            f.write(f"✔ Monthly Recovery Brazil actualizado el {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
    ...
    try:
        ...
        mensaje['Subject'] = "Informe de Recovery - Brasil"
